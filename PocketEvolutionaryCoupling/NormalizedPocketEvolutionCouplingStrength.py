...
#np.savetxt("NormalizedPocketsEvolutionaryCouplingStrength_Rank_{0}.txt".format(pdbID),Zscore_rank,fmt='%s %.2f')
#np.savetxt("SumFNList_{0}.txt".format(pdbID),SumcorrList,fmt='%.2f')
